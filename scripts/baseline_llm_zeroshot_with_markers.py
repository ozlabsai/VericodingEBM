...
async def score_record(client: httpx.AsyncClient, slug: str, label: str,
    ...
    async with sem:
        # AUDIT VARIANT: DO NOT strip // FAILS markers. This tests whether
        # frontier LLMs are also vulnerable to the marker leak our specialist
        # was caught on in run #7.
        impl_text = record.get("impl_text", "") or ""
