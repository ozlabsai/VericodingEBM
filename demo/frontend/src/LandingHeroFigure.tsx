  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      if (m.in) {
        ...
        halo.addColorStop(0, 'rgba(99, 188, 234, 0.10)')   // Dynamic Blue at low alpha
        halo.addColorStop(1, 'rgba(99, 188, 234, 0)')
        ctx.fillStyle = halo
        ctx.beginPath()
      ...
      if (nearestPoint && nearestDist < cursorR2 * 4) {
        ...
        ctx.strokeStyle = 'rgba(99, 188, 234, 0.85)'   // Dynamic Blue, opaque enough for light bg
        ctx.lineWidth = 1
